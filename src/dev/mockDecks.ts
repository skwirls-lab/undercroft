...
export const DEV_MOCK_DECKS: Deck[] = [
  {
    ...
    unresolvedCount: 1,
    totalCards: 43,
    legality: { legal: false, issues: 2, summary: ['41 cards — 59 more to reach 100.', '1 name not found in the card database.'], checkedAt: Date.now() - 3600000 },
  ...
  },
  {
    ...
    unresolvedCount: 0,
    totalCards: 42,
    legality: { legal: true, issues: 0, summary: [], checkedAt: Date.now() - 7200000 },
