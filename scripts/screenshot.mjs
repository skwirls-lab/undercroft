...
const SCREENS = [
  ...
  { name: 'patron-sheet', path: '/?patron=open&plan=free' },
  { name: 'patron-sheet-member', path: '/?patron=open' },
  ...
  { name: 'learn-quiz', path: '/learn/commander', scrollTo: '#quiz', click: '[data-dev-quiz-choice]:nth-of-type(2)' },
  ...
  { name: 'prompt-attackers', path: '/dev/board?choice=attackers' },
